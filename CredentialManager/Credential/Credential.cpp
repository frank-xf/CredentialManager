...
namespace bnb
{
    ...
    bool Credential::FromXml(const memory_type& mt)
    {
        ...
        m_strComment = node_credential.attribute("comment").value();
        ...
        for (auto node_platform : node_credential.children("platform"))
        {
            ...
            auto ptr_platform = m_Tree.Insert({
                name_attr_platform.value(), node_platform.attribute("url").value(), node_platform.attribute("comment").value() }
            );
            ...
            for (auto node_account : node_platform.children("account"))
            {
                ...
                auto ptr_account = ptr_platform->m_Value.Insert({ name_attr_account.value(), node_account.attribute("comment").value() });
    ...
    bool Credential::ToXml(memory_type& mt) const
    {
        ...
        node_credential.append_attribute("comment").set_value(m_strComment.c_str());
        ...
        m_Tree.Foreach([&node_credential](const platform_tree::data_type& platform) {
            ...
            node_platform.append_attribute("comment").set_value(platform.m_Key.m_strComment.c_str());
            ...
            platform.m_Value.Foreach([&node_platform](const account_tree::data_type& account) {
                ...
                node_account.append_attribute("comment").set_value(account.m_Key.m_strComment.c_str());
