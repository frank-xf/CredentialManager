...
public:
    ...
    virtual bool OnAddPair(unsigned int id1, unsigned int id2, unsigned int id3) { return false; }
    ...
    virtual bool OnUpdatePair(unsigned int id1, unsigned int id2, unsigned int id3, unsigned int id4) { return false; }
    ...
    virtual bool OnRemovePair(unsigned int id1, unsigned int id2, unsigned int id3, unsigned int id4) { return false; }
